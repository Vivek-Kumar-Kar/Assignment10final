using System;
using System.IO;
namespace Assignment10final
{
    internal class Program
    {
        public static void createFile()
        {
            Console.WriteLine("Enter Path for the new file");
            ...
            else
            {
                ...
                sw.Dispose();
                sw.Close();
                Console.WriteLine("File is Created in the Directory");
            }
        }
        ...
        public static void deleteFiles()
        {
            ...
            Console.WriteLine("File is Deleted from the Directory");
        }
